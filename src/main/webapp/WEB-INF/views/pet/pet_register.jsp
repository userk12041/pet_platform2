...
<label>
    ...
    종류: <input type="text" name="type" required><br><br>
    나이: <input type="number" name="age"><br><br>
    설명: <textarea name="description" rows="4" cols="40"></textarea><br><br>
   <!--  이미지 : <input type="file" name="image"><br><br>-->
    <input type="submit" value="등록">
</form>
<a href="${pageContext.request.contextPath}/pet/list">목록으로</a>
</body>
</html>
